...
class AnalizadorSintactico {
    ...
    private Sentencia sentenciaSi() {
        ...
        return new Sentencia.Si(tokenSi, condicion, ramaSi, ramaSino);
    }

    private Sentencia sentenciaMientras() {
        Token tokenMientras = anterior();
        ...
        return new Sentencia.Mientras(tokenMientras, condicion, cuerpo);
    }

    private Sentencia sentenciaPara() {

        Token tokenPara = anterior();
        ...
        cuerpo = new Sentencia.Mientras(tokenPara, condicion, cuerpo);
